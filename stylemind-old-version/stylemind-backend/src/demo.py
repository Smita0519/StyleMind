...
def main():
    ...
    while True:
        ...
        try:
            # debug=True -> prints mask/crop bounding boxes and saves
            # debug_mask_overlay.png for this image, useful while tuning
            # the segmentation pipeline. Set to False for quieter output.
            result, seg = predict(image_path, return_segmentation=True, debug=True)
